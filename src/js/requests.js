...
`
                ...
                `<button class="request-delete" title="Delete" onclick="deleteIncomingRequest('${req.id}')"> 
                🗑
                </button>
                `
                :""
    ...
    requests.forEach(req => {
        ...
        container.innerHTML += `
            ...
            <div class="request-footer">
                ...
                ${
                    ["completed","cancelled","declined"].includes(req.status)?
                    `<button class="request-delete" title="Delete" onclick="deleteOutgoingRequest('${req.id}')">
                    🗑
                    </button>
                    `
                    : ""
